...
namespace ProjetoQuiz
{
    public partial class frmPergunta6 : Form
    {
        ...
        {
            //Se o quarto radiobutton(alternativa correta) estiver selecionado, é chamado o método Dados.Acertou() para adicionar +1 no valor do acerto, se não, acrescenta +1 no valor do erro
            if (radRes4.Checked)
            {
                Dados.Acertou();
            }
