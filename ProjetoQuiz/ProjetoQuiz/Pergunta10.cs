...
namespace ProjetoQuiz
{
    public partial class frmPergunta10 : Form
    {
        ...
        {
            //O botão Finalizar só fica disponivel se algum radiobutton for selecionado
        ...
        {
            //Se o primeiro radiobutton(alternativa correta) estiver selecionado, é chamado o método Dados.Acertou() para adicionar +1 no valor do acerto, se não, acrescenta +1 no valor do erro
            if (radRes1.Checked)
            {
                Dados.Acertou();
            }
            ...
            //Abre o formulário de carregamento
