...
namespace ProjetoQuiz
{
    public partial class frmPergunta5 : Form
    {
        ...
        {
            //Se o terceiro radiobutton(alternativa correta) estiver selecionado, é chamado o método Dados.Acertou() para adicionar +1 no valor do acerto, se não, acrescenta +1 no valor do erro
            if (radRes3.Checked)
            {
                Dados.Acertou();
            }
